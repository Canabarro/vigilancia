        ...
        <div class="container">
            <div class="">
                <div class="painel-center">
                    <label class="form-label" for="nome">Nome do cargo:</label>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $checkQuery = "SELECT * FROM cargo WHERE nome = '$nome'";
                    ...
                    if ($checkResult->num_rows > 0) {
                        ...
                        $sql = "INSERT INTO cargo (nome, descricao) VALUES ('$nome', '$descricao')";

                        // Executando a consulta
                        if ($mysqli->query($sql) === TRUE) {
                            echo "<br><div class=\"confirm-alert\" role=\"alert\"> Cadastro realizado com sucesso!</div>";
                        } else {
                            echo "Erro ao cadastrar o cargo: " . $mysqli->error;
                        }
                    }
