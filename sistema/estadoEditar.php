        ...
        <div class="container">
            ...
            <form method="POST" action="">
                ...
                ?>
                        ...
                        <div class="center-formulario">
                            <div class="painel-formulario">
                                ...
                                <input class="form-control" type="text" name="NovoSigla" value="<?php echo $dadoAntigo['sigla'] ?>" required><br><br>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE estado SET nome = '$NovoNome', sigla = '$NovoSigla' WHERE codigo = $codEstado";
