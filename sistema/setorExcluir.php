        ...
        <div class="container">
            ...
            <form method="POST" action="">
                ...
                ?>
                        ...
                        <h3>Exlcuir cadastro de setor</h3>
                        <div class="center-formulario">
                            <div class="painel-formulario">
                                <p>Deseja mesmo exlcuir o cadastro deste setor?</p><br>

                                <div class="alert">Você pode ter outros cadastros já vinculados a este setor!</div>

                                <label class="form-label" for="nome">Nome:</label>
                                <p><?php echo $dadoAntigo['nome'] ?></p><br><br>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "DELETE FROM setor WHERE codigo = $codSetor";
                    ...
                    if ($mysqli->query($sql) === TRUE) {
                        ...
                        header("Location: setorListar.php");
                    } else {
