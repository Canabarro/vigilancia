...
<head>
    ...
    <title>Excluir cadastro de estado</title>
        ...
        <div class="container">
            ...
            <form method="POST" action="">
                ...
                ?>
                        ...
                        <div class="center-formulario">
                            <div class="painel-formulario">
                                <p>Deseja mesmo exlcuir o cadastro deste estado?</p><br>

                                <label class="form-label" for="nome">Nome:</label>
                                <a><?php echo $dadoAntigo['nome'] ?></a><br><br>

                                <label class="form-label" for="cpf">Sigla:</label>
                                <a><?php echo $dadoAntigo['sigla'] ?></a><br><br>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "DELETE FROM estado WHERE codigo = $codEstado";
                    ...
                    if ($mysqli->query($sql) === TRUE) {
                        ...
                        header("Location: estadoListar.php");
                    } else {
