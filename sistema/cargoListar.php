...
$registrosPorPagina = 14; // Número de registros exibidos por página

// Obter o número total de registros na tabela
$sqlTotalRegistros = "SELECT COUNT(*) AS total FROM cargo";
...
<header>
    ...
    <div class="container">
    <h1>Listagem - Cargos</h1>

    <div class="opcoes-line">
        <a href="cargoCadastrar.php">Cadastrar</a> <a href="">Consultar</a><a href="adminPage.php">voltar</a>
    </div>
<br>
        ...
        <table>
            ...
            ?>
                    <tr>
                        <td><?php echo $codCargo; ?> </td>
                        <td><?php echo $row['nome']; ?></td>
                        <td><a href='cargoEditar.php?codigo=<?php echo $codCargo ?>'> <i class='fa-solid fa-pen-to-square'></i></a><a href='cargoExcluir.php?codigo=<?php echo $codCargo ?>'> <i class='fa-solid fa-trash'></i></a><a href=''> <i class='fa-solid fa-circle-info'></i></a>
                    </tr> <?php
                        }
                    } else {
