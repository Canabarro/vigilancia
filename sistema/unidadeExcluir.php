        ...
        <div class="container">
            ...
            <form method="POST" action="">
                ...
                if (isset($_GET['codigo'])) {
                    ...
                    $sqlConsult = "SELECT * FROM unidade
                ...
                ?>
                        <div class="center-formulario">
                            <div class="painel-formulario">
                                <h4>Deseja mesmo exlcuir o cadastro desta unidade?</h4>
                                <p><?php echo $dadoAntigo['nome'] . " - " . $dadoAntigo['cnpj'] ?></p>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($mysqli->query($sql) === TRUE) {
                        ...
                        header("Location: unidadeListar.php");
                    } else {
